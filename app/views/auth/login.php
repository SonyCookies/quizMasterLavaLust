            ...
            <div class="flex justify-center">
                <div class="w-full max-w-md">
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        <div class="bg-gray-800 text-white text-lg font-semibold p-4">Login</div>
                        <div class="p-6">
                            <?php flash_alert(); ?>
                            <form id="logForm" method="POST" action="<?= site_url('auth/login'); ?>">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input id="email" type="email" class="block w-full px-3 py-2 border rounded-lg <?php echo $LAVA->session->flashdata('is_invalid') ? 'border-red-500' : 'border-gray-300'; ?>" name="email" required autocomplete="email" autofocus>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input id="password" type="password" class="block w-full px-3 py-2 border rounded-lg border-gray-300" name="password" minlength="8" required autocomplete="current-password">
                                </div>
