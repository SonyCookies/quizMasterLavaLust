        ...
        <aside id="sidebar" class="sidebar fixed left-0 top-0 z-40 h-screen w-64 border-r bg-white transition-transform duration-300 ease-in-out md:translate-x-0">
            <div class="flex h-full flex-col">
                ...
                <nav class="flex-1 space-y-1 px-2 py-4">
                    ...
                    <a href="<?= site_url('admin/users'); ?>" class="flex items-center gap-2 rounded-lg px-3 py-2 text-white bg-blue-500">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="p-4 md:p-6">
                <div class="mb-8 grid grid-cols-4 gap-4">
                    ...
                    <div class="col-span-2 flex justify-between rounded-lg bg-gradient-to-br from-orange-500 to-orange-700 p-6 text-white shadow-md">
                        <div class="flex flex-col  justify-center gap- font-bold text-2xl">
                            Deactivated Users
                            <span class="text-base text-gray-200 font-normal">List of all deactivated users from QuizMaster</span>
                        </div>
